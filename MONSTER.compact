# Dokumenttitason otsikko (ei workout, ignoroidaan)
# Compact Test Corpus - All Variants

------------------------------------------------------------

[2026-02-23#w001] ## Perinteinen workout meta + otsikko
Tags juoksu, voimakestävyys, test
Emojis 🏃⚡💪
Summary Testataan kaikki muodot
Level0 juoksu
Level1 intervallit
Level2 tekniikka
...
# kommenttirivi workoutin sisällä (Comment -> text)
...
Circuit|4/2min | kontrastivoimapiiri
> Takakyykky 5@100kg
> Loikat 8
> Penkkipunnerrus 5@70kg
> Pallon heitto 8

Superset|3
> Hauiskääntö 12@10kg
> Ojentajapunnerrus 12@10kg/30s
...
## [2026-02-24#w003] Otsikossa meta (## [meta] title)
Tags test, otsikko-meta
Emojis 🧪📌
Section Otsikon testit
Run 50m @90%/100m | nopea
> 50m 0:07/m 170bpm | splitillä outo pace-yksikkö (tarkoituksella)

------------------------------------------------------------

[2026-02-23]
## Meta omalla rivillä + otsikko
Tags meta-erillisellä-rivillä
Emojis 🧷
Section Pääosa
Exercise Penkkipunnerrus|3x8@80kg
...
[2026-02-23#?] ## Päivä + #? (id null)
Tags id-null
Emojis ❔
Exercise Leuanveto|1xMax@bw

------------------------------------------------------------

[#?] ## Vain #? (date null, id null)
Tags placeholder
Emojis 🕳️
Exercise Paikkaaja|nullx

------------------------------------------------------------

[2026-02-25]
Exercise Otsikoton workout alkaa suoraan contentista|3x10@20kg
Tags otsikoton
Emojis 🧩
Section Ilman otsikkoa
Run 10x? @easy | unknown distance count-only
> Split 5min | split ilman distancea

------------------------------------------------------------

# Dokumenttitason alaotsikko (ei workout, ignoroidaan)
## Tämä on doc-tason SectionHeader ja ohitetaan
